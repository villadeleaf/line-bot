    ...
    try {
      ...
      if (q.ask) {
        ...
        extra +=
          ...
          `⚠️ ราคา: คิดจาก "ตารางราคาในคลังความรู้" เท่านั้น ห้ามใช้ตัวเลขราคาจากข้อมูลระบบนี้ — วิธีเลือกคอลัมน์: ถ้าป้ายช่วงวันบอก "วันหยุดยาว/เทศกาล" ให้ใช้คอลัมน์วันหยุดยาว/เทศกาลของตาราง (ต่อให้เป็นเดือน Low season ก็ตาม — กฎ B) · ป้าย "ปกติ" = คิดตามฤดู+วันในสัปดาห์ตามกฎเดิมของตาราง · ` +
